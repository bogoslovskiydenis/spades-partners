        ...
        <div class="policy-text">
          ...
          <section class="policy-section">
            ...
            <div class="definition-item">
              ...
              this Agreement) refers to spades partners.
            </div>
            ...
            <div class="definition-item"><strong>Country</strong> refers to: Berlin, Germany</div>
            ...
            <div class="definition-item">
              <strong>Website</strong> refers to spades partners, accessible from
              https://spadespartners.com/
            </div>
          ...
          <section class="policy-section">
            ...
            <div class="tracking-item">
              ...
              <div>
                The information gathered by Google Places is held in accordance with the Privacy
                Policy of Google:
                <a
                  href="https://www.google.com/intl/en/policies/privacy/"
                  target="_blank"
                  rel="noopener noreferrer"
                  style="color: #cd9f55; text-decoration: underline"
                >
...
useHead({
  title: 'Privacy Policy - Spades Partners',
  meta: [
    {
      name: 'description',
      content:
        'Privacy Policy for Spades Partners. Learn how we collect, use and protect your personal information.',
    },
